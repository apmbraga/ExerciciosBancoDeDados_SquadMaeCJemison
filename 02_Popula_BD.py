...
cursor.execute('UPDATE livros SET FG_disponivel = 0 where id_livro IN ("10","15","4")')

#cursor.execute('INSERT INTO emprestimos (id_usuario, id_livro, data_emprestimo, data_devolucao, FG_devolvido) VALUES (4,12,"2023-10-01", "2023-10-25",1), (7,8,"2023-11-08", "2023-11-25",1), (6,4,"2023-12-01", "2023-12-25",1), (3,7,"2023-10-07", "2023-10-29",1), (5,18,"2023-11-07", "2023-11-29",1),(6,10,"2024-02-05", "2024-02-29",0),(5,15,"2024-02-03", "2024-02-25",0),(1,4,"2024-02-01", "2024-02-20",0),(7,10,"2024-01-10", "2024-01-20",1),(2,9,"2024-02-01", "2024-02-20",1)')
